...
4. **Hand mechanical breadth back.** If implementing the decision means propagating a change across many sites, return the decision plus the site list instead of editing them all — the senior dispatches worker-tier for that.
