 ...
 * content block carrying a `ur|hnt` line followed by structured key/value
 ...
 *   - Legend agreement: `ur|hnt` is "hint — guidance / co-change".
 *
...
> = {
	...
	mark_decision: { tool: "mark_intent", example: 'mark_intent({intent:"<one sentence>"})' },
	mark_blocker: { tool: "mark_intent", example: 'mark_intent({intent:"<one sentence>"})' },
	mark_resolution: {
		tool: "mark_blocker",
