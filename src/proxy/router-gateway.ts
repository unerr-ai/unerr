...
export interface RecordAndUnlockOutcome {
	...
	/** Inline `ur|hnt` lines to prepend to body text. Empty when no unlocks. */
			...
			.append(
				{
					...
					wasMaskedReason: outcome === "soft_refused" ? "tier_locked" : undefined,
					tokensIn,
					tokensSaved,
					latencyMs,
